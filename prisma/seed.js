...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var prepareData, enSeeds, daSeeds, _i, _a, translation, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, 6, 8]);
                    prepareData = function (data, lang) {
                    ...
                    enSeeds = prepareData({
                        ...
                        house_description_1: "Blommehuset in Marielyst is an ideal place for a fantastic holiday experience, where the facilities and location combine to create the perfect setting. Located in the popular holiday area Marielyst, this summer house is close to restaurants, shopping, and the beach, providing all the necessary conveniences within reach.",
                        house_description_2: "This spacious summer house offers a wide range of facilities suitable for all tastes and age groups. Indoors, you can enjoy a private pool area with a 22 m² pool, complete with a water slide for the children, a spacious 6-person hot tub, and a large sauna for ultimate relaxation. There are also two separate activity rooms where you can challenge each other in various games such as table tennis, billiards, and darts. The open and well-equipped kitchen-living area provides space for shared cooking and cozy meals around the long dining table.",
                        house_description_3: "Outdoors, there is a large terrace with garden furniture and a grill where you can enjoy the Danish summer days and cook under the open sky. The surrounding plot of 2100 m² is perfect for children, with a large lawn for play and ball games.",
                        house_description_4: "The summer house contains a total of 6 double rooms and 2 lofts, providing space for up to 18 people. There are also facilities for the youngest, including a baby cot and a high chair.",
                        house_description_5: "This summer house is suitable for various occasions, including family birthdays, confirmations, weddings, and company events.",
                        ...
                        missing_booking_description: "Please complete your booking selection before proceeding to checkout.",
                        ...
                        contact_info_description: "We'll use this email to send you details and updates about your order.",
                        ...
                        tvDesc1: "Blommehuset, where comfort and entertainment go hand in hand. With an impressive 85″ screen in the living room, you get a cinema-like experience in your holiday paradise. This large screen ensures that all guests can enjoy crystal-clear images and an amazing visual experience, no matter where they sit.",
                        tvDesc2: "Blommehuset not only offers a wealth of entertainment options with access to 28 channels, including German channels, but also Netflix and YouTube Premium Universe. Whether you are into movies, series, or videos, there is something for everyone.",
                        tvDesc3: "Imagine how an evening of movies and streaming on the big screen can bring the family together and create unforgettable memories. Our summer house is designed to make your stay as comfortable and entertaining as possible. Blommehuset is designed to make your stay as comfortable and entertaining as possible.",
                    ...
                    daSeeds = prepareData({
                        ...
                        descriptionText: "En afslappende og mindeværdige ophold for familier, venner og alle, der søger en pause fra hverdagens travlhed. Blommehuset er det ideelle tilflugtssted, hvor moderne komfort møder naturskønne omgivelser. Med sin charmerende atmosfære og bekvemmelige faciliteter giver det dig mulighed for at nyde alt, hvad Marielyst har at byde på.",
                        luxuryExperience: "Inspireret af dansk luksus og omgivet af naturskønne omgivelser, er vores sommerhus designet til at tilbyde en uforglemmelig oplevelse. Fra afslappende stunder i naturen til spændende aktiviteter, er vores mål at holde dig underholdt og forkælet under hele dit ophold.",
                        availableVia: "AUCH ERHÄLTLICH ÜBER",
                        headline: "Sommerhus ved Marielyst",
                        subheadline: "Et skridt væk fra hverdagens stress, et skridt ind i sommerhusidyllen",
                        ...
                        blommehusetDescription: "Blommehuset i Marielyst er et ideelt sted for en fantastisk ferieoplevelse, hvor faciliteterne og beliggenheden kombineres til at skabe den perfekte ramme. Placeret i det smukke Marielyst-område, tilbyder det komfort og stil for alle gæster.",
                        experienceMessage: "EN OPLEVELSE, DER VIL FÅ DIG TIL AT KOMME TILBAGE IGEN OG IGEN.​",
                        ...
                        marielystArea: "Området omkring Marielyst byder på en væld af oplevelser og aktiviteter.",
                        surfCenterFalster: "Surfcenter Falster",
                        surfCenterDescription: "Surfcenter Falster tilbyder en bred vifte af aktiviteter, herunder windsurfing, kitesurfing, SUP (stand-up paddle) og kajakroning. Uanset om du er nybegynder eller erfaren, har vi udstyr og undervisning tilpasset dit niveau.",
                        discoverMore: "Opdag Mere",
                        marielystOldBathingTown: "Marielyst – Den gamle badeby",
                        marielystDescription: "Marielyst – Den gamle badeby er en charmerende destination med mere end 100 års historie. Beliggende på Falster, byder byen på en vidunderlig sandstrand, hyggelige caféer og spændende aktiviteter for hele familien. Perfekt til en afslappende ferie ved havet!",
                        bikeHikingTours: "Cykel- og vandreture",
                        bikeHikingDescription: "Udforsk den smukke natur omkring Marielyst med velanlagte cykel- og vandreruter gennem skov, marker og langs kysten.",
                        guestExperienceTitle: "GÆSTE OPLEVELSER",
                        guestReview: '"Der manglede intet. Der var massere af aktiviteter i huset og lækkert at det var så tæt på vandet. / Overdragelsen og tilbageleveringen foregik problemfrit, om kommunikationen med ejeren for god og hyggelig. / Super ferie!."',
                        reviewerDetails: "Tina – Søborg (Familieferie med større børn, februar 2021)",
                        summerHouseInspiration: "Inspireret af dansk sommer, omgivet af naturen, der vækker minder mange år frem.",
                        summerHouseOffers: "Sommerhuset Tilbyder",
                        facilitiesTitle: "All de nødvendige faciliteter til et hyggeligt og behageligt ophold",
                        pool: "Pool",
                        poolDescription: "18m2 stor pool med rutchebane for de små og en 6 personer indendørs spa.",
                        caretaker: "Vicevært",
                        caretakerDescription: "En vicevært er tilknyttet sommerhuset og vil være behjælpelig med eventuelle problemer, der måtte opstå.",
                        wifi: "Wifi & Internet",
                        wifiDescription: "Lynhurtig 100 / 100 forbindelse til den store familie.",
                        appliances: "Alle Fornødne Hvidevare",
                        appliancesDescription: "Opvaskemaskine, vaskemaskine, tørretumbler, køleskab og fryser er tilgængelige i sommerhuset.",
                        tvPackage: "TV Pakke",
                        tvPackageDescription: "Tilbyder et bredt udvalg af populære kanaler, herunder underholdning, sport, nyheder og børneprogrammer, noget for hele familien.",
                        activities: "Billiard / Bordtennis mm.",
                        activitiesDescription: "Glæd dig til en bred vifte af sjove og spændende aktiviteter, der er skræddersyet til at underholde hele familien og sikre, at I får en uforglemmelig tid sammen.",
                        ...
                        about_paragraph: "Nær Marielysts skønne strand ligger dette hyggelige Skanlux-poolhus med plads til hele familien. Med placering i ferieparadiset Marielyst – nær både restauranter, indkøb og strand – er udgangspunktet for en god ferie på plads!",
                        ...
                        about_paragraph_1: "Indendørs finder i ligeledes gode rammer for en dejlig ferie. Huset byder på både komfort og hygge med rummeligt køkken-alrum, helt egen poolafdeling og aktivitetsrum.",
                        about_paragraph_2: "Husets flotte poolafdeling indeholder pool med vandrutsjebane, et dejligt 6-personers spabad samt en stor sauna, hvor feriestemningen rigtigt kan sprede sig.",
                        about_paragraph_3: "I aktivitetsrummet er der ligeledes lagt op til gode timer. Her er der ingen undskyldning for at sidde stille, når der både kan dystes i bordtennis/billard og dart.",
                        about_more_info: "Og lidt mere...",
                        about_kitchen_garden_title: "Køkken, have og gode nætter",
                        about_kitchen_paragraph_1: "Køkkenet er åbent og velindrettet, så der uden problemer kan være mange kokke og køkkenskrivere om den fælles madlavning. Efterfølgende kan måltidet nydes ved det lange spisebord, hvor hele flokken kan samles.",
                        about_kitchen_paragraph_2: "Den danske sommer kan nydes på terrassen i gode havemøbler, hvor også maden kan tilberedes på grill. På den store grund, der omkranser huset, er der også tænkt på de mindste gæster med sandkasse, legetårn og stor græsplæne.",
                        about_kitchen_paragraph_3: "Når alle mand skal sove foregår dette i en af de to soveafdelinger med hver 3 dobbeltværelser. De sidste 6 sovepladser finder I på en af sommerhusets 2 hemse.",
                        ...
                        about_blommehuset_description_3: "Udendørs er der en stor terrasse med havemøbler og grill, hvor I kan nyde de danske sommerdage og lave mad under åben himmel. Den omkringliggende grund på 2100 m² er perfekt til børnene, stor græsplæne til leg og boldspil.",
                        about_blommehuset_description_4: "Sommerhuset rummer i alt 6 dobbeltværelser og 2 hemse, hvilket giver plads til op til 18 personer. Der er også faciliteter til de mindste, herunder en barneseng og en høj stol.",
                        about_blommehuset_description_5: "Dette sommerhus er velegnet til forskellige lejligheder, herunder familiefødselsdage, konfirmationer, bryllupper og firmaarrangementer.",
                        ...
                        house_description_1: "Blommehuset i Marielyst er et ideelt sted for en fantastisk ferieoplevelse, hvor faciliteterne og beliggenheden kombineres til at skabe den perfekte ramme. Placeret i det populære ferieområde Marielyst, er dette sommerhus nær restauranter, indkøbsmuligheder og stranden, hvilket giver jer alle de nødvendige bekvemmeligheder inden for rækkevidde.",
                        house_description_2: "Dette rummelige sommerhus tilbyder en bred vifte af faciliteter, der passer til enhver smag og aldersgruppe. Indendørs kan I nyde en privat poolafdeling med en 22 m² stor pool, komplet med vandrutsjebane til børnene, et rummeligt 6-personers spabad og en stor sauna til ultimativ afslapning. Der er også to separate aktivitetsrum, hvor I kan udfordre hinanden i forskellige spil som bordtennis, billard og dart. Det åbne og velindrettede køkken-alrum giver plads til fælles madlavning og hyggelige måltider rundt om det lange spisebord.",
                        house_description_3: "Udendørs er der en stor terrasse med havemøbler og grill, hvor I kan nyde de danske sommerdage og lave mad under åben himmel. Den omkringliggende grund på 2100 m² er perfekt til børnene, stor græsplæne til leg og boldspil.",
                        house_description_4: "Sommerhuset rummer i alt 6 dobbeltværelser og 2 hemse, hvilket giver plads til op til 18 personer. Der er også faciliteter til de mindste, herunder en barneseng og en høj stol.",
                        house_description_5: "Dette sommerhus er velegnet til forskellige lejligheder, herunder familiefødselsdage, konfirmationer, bryllupper og firmaarrangementer.",
                        ...
                        missing_booking_description: "Venligst fuldfør din booking før du går videre til checkout.",
                        ...
                        contact_info_description: "Vi bruger denne e-mail til at sende dig detaljer og opdateringer om din bestilling.",
                        first_name: "Fornavn",
                        last_name: "Efternavn",
                        email: "E-mail",
                        phone: "Telefon",
                        ...
                        tvDesc1: "Blommehuset, hvor komfort og underholdning går hånd i hånd. Med en imponerende 85″ skærm i stuen får du en biografoplevelse i dit ferieparadis. Denne store skærm sikrer, at alle gæster kan nyde krystalklare billeder og en fantastisk visuel oplevelse, uanset hvor de sidder.",
                        tvDesc2: "Blommehuset tilbyder ikke kun et væld af underholdningsmuligheder med adgang til 28 kanaler, inklusive tyske kanaler, men også Netflix og YouTube Premium Univers. Uanset om du er til film, serier eller videoer, er der noget for enhver smag.",
                        tvDesc3: "Forestil dig, hvordan en aften med film og streaming på den store skærm kan samle familien og skabe uforglemmelige minder. Vores sommerhus er designet til at gøre dit ophold så behageligt og underholdende som muligt. Blommehuset er designet til at gøre dit ophold så behageligt og underholdende som muligt.",
                    ...
                    _i = 0, _a = __spreadArray(__spreadArray([], enSeeds, true), daSeeds, true);
                    _b.label = 1;
                case 1:
                    if (!(_i < _a.length)) return [3 /*break*/, 4];
                    translation = _a[_i];
                    return [4 /*yield*/, prisma.translation.upsert({
                            where: {
                                key_language: {
                                    key: translation.key,
                ...
                case 5:
                    err_1 = _b.sent();
                    console.error("❌ Error seeding translations:", err_1);
                    return [3 /*break*/, 8];
