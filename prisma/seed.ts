...
async function seed() {
  try {
    ...
    for (const translation of [...enSeeds, ...daSeeds]) {
      await prisma.translation.upsert({
        ...
        update: { value: translation.value, type: translation.type },
        create: translation,
      });
    }

    console.log("✅ Seeding complete for English and Danish translations!");
  } catch (err) {
